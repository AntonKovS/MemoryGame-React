...
class App extends React.Component {
    ...
    prepareCards() {
        ...
        return [...config.cards, ...config.cards]
            .sort(() => Math.random() - 0.5)    //один из способов рандомно отсортировать массив
    ...
    render() {
        return (
            <div className="App">
                <header className="header">Memory Game</header>     {/*используем двойные кавычки ".." , чтобы передать туда сразу строку.*/}
                <div className="game">
                    <div className="score">
